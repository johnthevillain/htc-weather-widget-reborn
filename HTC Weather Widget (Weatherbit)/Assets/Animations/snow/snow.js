var snow = {
    ...
    createADrop: function() {
        ...
        image.src = "snow/snow-" + this.randomInteger(1, this.NUMBER_OF_IMAGES) + ".png";
        ...
        var fadeAndDropDuration = this.durationValue(this.randomFloat(5, 7));
        var spinDuration = this.durationValue(this.randomFloat(8, 8));
